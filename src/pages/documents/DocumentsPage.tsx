      ...
      <div className="flex justify-between items-center">
        ...
        <div>
          ...
          <label htmlFor="fileUpload" className="cursor-pointer">
            <Button leftIcon={<Upload size={18} />} onClick={() => document.getElementById('fileUpload')?.click()}>
              Upload Document
            </Button>
          </label>
          {uploadedFile && (
      ...
      <div className="mt-6">
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-500">Sign documents digitally</p>
          </CardHeader>
          <CardBody>
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              <p className="text-gray-500 mb-4">Darw your signature below</p>
